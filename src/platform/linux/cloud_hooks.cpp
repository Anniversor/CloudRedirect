...
static void EnsureInitialized() {
    ...
    std::call_once(s_initFlag, []() {
        ...
        // One provider search enumerates every legacy per-app blob of the account,
        // so startup no longer probes each unlocked app one by one. Google Drive
        // vouches for a complete listing; anything less falls back to the probes.
